...
def speech_to_text(model):
    ...
    # These lines were outside the function body - they need to be indented properly
...
def add_strengths_and_weaknesses_to_portfolio(portfolio_file_path, analysis_text):
    with open(portfolio_file_path, 'a') as file:
